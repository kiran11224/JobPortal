                    ...
                    <div class="mb-4">
                        <h2>Job Type</h2>
                             ...
                             @if ($jobTypes->isNotEmpty())
                                ...
                                <input class="form-check-input " name="job_type" type="checkbox" value="1" id="{{ $jobTypes->id }}">   
                            <label class="form-check-label " for="{{ $jobTypes->id }}">{{ $jobTypes->name }}</label>
                                 </div>
                                 @endforeach
                            @endif 
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <p>{{ Str::words($jobs->description,5)}}</p>
                                    <div class="bg-light p-3 border">
                                        ...
                                        <p class="mb-0">
                                            <span class="fw-bolder"><i class="fa fa-usd"></i></span>
                                            <span class="ps-1">Not Disclose</span>
                                        </p>
                                        @endif
